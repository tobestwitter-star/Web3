...
contract PriceLedger {
 ...
 function borrow(uint256 units) external { uint256 p=feed.read(); uint256 value=units*p; require(value<cash); debt[msg.sender]+=value; cash-=value; payable(msg.sender).transfer(value); }
}
