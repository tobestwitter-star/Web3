...
contract ReproductionTest {
 ...
 function testStateMachineSecurityProperty() public { StateMachineVault v=new StateMachineVault(); v.prepare(); address other=address(0xBEEF); vm.prank(other); v.execute(other,1 ether); require(v.credit(other)==0,"security property violated: execute reachable without authorized preparer"); }
