...
def test_unrelated_engine_evidence_cannot_raise_or_reduce_relevant_confidence():
    ...
    assert unrelated["relevant_independent_engine_count"] == 1
    assert unrelated["unrelated_evidence_count"] == 1
